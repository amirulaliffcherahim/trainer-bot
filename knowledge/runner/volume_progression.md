...
## The 10% rule (hard cap, enforced in code)
- Weekly volume (km) must never increase more than **10% vs the previous
  week**. This is a hard cap: the bot will not propose more, and the athlete
  should not accept a plan that exceeds it.
- Decreases are always allowed (recovery, illness, heat).
...
- Taper: last 3 weeks — week −3: 75% volume, week −2: 55%, race week: 35% with
  easy pace only.

## When to cut back
- Two or more poor nights of sleep, illness, or a fatigue trend up 2+ weeks:
  drop volume 20–30% that week.
- Any sharp pain: stop, see physio advice. Volume rules do not override injury.
